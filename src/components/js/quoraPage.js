...
import QuoraLine from "@/components/QuoraLine.vue";
import QuoraPie from "@/components/QuoraPie.vue";
      ...
      const fetchData = async () => {
        try {
          const response = await fetch(
            "http://10.20.3.173:8090/logging/categoryCountByServiceApp/quora"
          );
